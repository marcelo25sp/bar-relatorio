...
public class Main {
	...
	public static void main(String[] args) {
		...
		char genero = Character.toUpperCase(sc.next().charAt(0)); // Converte para maiúsculo para evitar erro em 'f' ou
																	// 'm'
		...
		// cria o objeto Conta que armazena os dados do cliente acessando os atributos
		// da classe Conta
